...
INSERT INTO music (TITLE, VIDEO_ID, LIKES, VIEWS, COUNTRY, GENRE, SINGER, SONGWRITER,POSTWRITER, RELEASED, POSTED, MODIFIED, DELETED,USER_ID) VALUES
...
INSERT INTO lyric ( CONTENT, ORDER_NUMBER, MUSIC_ID,,USER_ID) VALUES
        ( 'Lyric 1', 1, 1,2),
        ( 'Lyric 2', 2, 1,1),
        ( 'Lyric 3', 1, 2,1);

-- Insert sample data into the 'lyricComment' table
INSERT INTO lyric_Comment ( CONTENT, LIKES, DISLIKES, REPORTS, WRITER, CREATED, MODIFIED, DELETED, LYRIC_ID,USER_ID) VALUES
